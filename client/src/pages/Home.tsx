      ...
      <section className="relative pt-20 pb-32 overflow-hidden bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-secondary font-medium text-sm mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/contact">
                  <Button variant="outline" size="lg" className="text-lg px-8 py-6 rounded-full border-2 bg-transparent hover:bg-muted">
                    Talk to an Advisor
                  </Button>
                </Link>
              </div>
            ...
            >
              ...
              <div className="aspect-square rounded-[2rem] bg-gradient-to-br from-secondary to-secondary/80 p-1 shadow-2xl rotate-3 hover:rotate-0 transition-all duration-500">
                <div 
              ...
              {/* Floating Badge */}
              <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl border border-border max-w-xs animate-bounce-slow">
                <div className="flex items-center gap-3 mb-2">
                  <div className="bg-green-100 p-2 rounded-full text-green-600">
                    <CheckCircle2 size={20} />
                  </div>
                  <span className="font-bold text-secondary">92% Hiring Rate</span>
                </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Skill Univ?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, idx) => (
              <motion.div
                ...
                className="p-8 rounded-2xl bg-muted/30 border border-border/50 hover:border-primary/50 transition-colors"
              >
                <div className="w-14 h-14 bg-primary/20 rounded-xl flex items-center justify-center text-secondary mb-6">
